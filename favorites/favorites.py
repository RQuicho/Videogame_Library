...
@favorites.route('/users/<int:user_id>/favorites', methods=['GET', 'POST'])
...
@favorites.route('/favorites/<int:game_id>', methods=['POST'])
...
@favorites.route('/delete_favorite/<int:game_id>', methods=['POST'])
